...
class ChatAudioMessageReceiverWidget extends StatefulWidget {
  final String horaMinuto;
  final String audioUrl;
  final String url;

  const ChatAudioMessageReceiverWidget({
    Key? key,
  ...
  @override
  _ChatAudioMessageReceiverWidgetState createState() => _ChatAudioMessageReceiverWidgetState();
}

class _ChatAudioMessageReceiverWidgetState extends State<ChatAudioMessageReceiverWidget> {
