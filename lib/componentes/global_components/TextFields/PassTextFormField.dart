...
class PassMyTextFormField extends StatelessWidget {
  final String hint;
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<MyPassTextFormFieldController>(
      init: MyPassTextFormFieldController(), // Inicializa o controlador
            ...
            decoration: InputDecoration(
              ...
              labelStyle: TextStyle(
                color: enable
                    ...
                    : (color?.withOpacity(0.2) ?? const Color.fromARGB(255, 200, 200, 200)), // Cor ajustada para desativado
                fontWeight: FontWeight.w400,
                fontSize: 12, // Tamanho da fonte da label
              ),
            ),
          ),
        ],
...
class MyPassTextFormFieldController extends GetxController {
  void updateState() {
