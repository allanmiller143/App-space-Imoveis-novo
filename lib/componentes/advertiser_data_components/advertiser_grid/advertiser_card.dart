...
class AdvertiserGridCard extends StatelessWidget {
  final property;
  MyGlobalController  myGlobalController = Get.find();
  AdvertiserGridCard({required this.property, Key? key}) : super(key: key);
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                mySnackBar('Funcionalidade em desenvolvimento', true);
                              },
                              child: Container(
                                ...
                                child: Text(
                                  'Detalhes anunciante', style: TextStyle(fontSize: 8,color: Colors.white),),
                              )
                            ),
                          ],
                        ),
