...
class RealtorRealStateGrid extends StatelessWidget {
  final String title;
  RealtorRealStateGrid({Key? key, required this.title}) : super(key: key);

  final RealtorRealStateGridController controller = Get.put(RealtorRealStateGridController());
  ...
  Widget build(BuildContext context) {
    return Obx(() => controller.isLoading.value
        ...
        : controller.realtors.isNotEmpty
            ? Column(
                children: [
                  // Padding(
                  //   key: _titleKey,
                  ...
                  Container(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        var realtor = controller.realtors[index];
                        return                              
                        RealtorRealStateCustomCard(
                          data : realtor
                        );
                      },
                    ),
